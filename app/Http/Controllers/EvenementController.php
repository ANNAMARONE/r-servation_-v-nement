...
class EvenementController extends Controller
{
    ...
    {
        $evenements = Evenement::all(); // Récupère tous les événements de la base de données
        return view('evenements.index', compact('evenements')); // Retourne la vue avec la liste des événements
    }
