...
@method('POST')
   ...
   <h1 class="titre1">Bienvenue sur <span class="my">My</span><span class="event">Event</span></h1> 
    ...
    <div>
        ...
        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="saisir votre Nom">
        @error('name')
            <div>{{ $message }}</div>
        @enderror
    </div>
    ...
    <div>
        ...
        <input type="password" id="password_confirmation" name="password_confirmation" placeholder="confrimer le mot passe"> 
    ...
    <div>
        ...
        <input type="text" id="adresse" name="adresse" value="{{ old('adresse') }}" placeholder="saisire votre Adresse">
        @error('adresse')
            <div>{{ $message }}</div>
        @enderror
    </div>
